package org.thoughtlabs.blogbackend.security.services.oauth2.user;
...
public class OAuth2UserInfoFactory {
    ...
    public static OAuth2UserInfo getOAuth2UserInfo(String registrationId, Map<String, Object> attributes) throws OAuth2AuthenticationProcessingException {
        if(registrationId.equalsIgnoreCase(AuthProvider.google.toString())) {
            ...
            throw new OAuth2AuthenticationProcessingException("Sorry! Login with " + registrationId + " is not available yet!");
        }
    }
}
