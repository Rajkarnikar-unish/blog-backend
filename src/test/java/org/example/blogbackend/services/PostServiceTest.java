...
// Post expectedPost = new Post(1L, "Test Post", "Test Content", new User(),
// LocalDateTime.now(),
// EPostStatus.PUBLISHED, LocalDateTime.now(), false);
...
// Optional<Post> post = Optional.of(new Post().withId(1L).withTitle("Spring
// Boot"));
...
// Optional<Post> post = Optional.of(new Post().withId(1L).withTitle("Test
// Delete"));
// when(postRepository.findById(1L)).thenReturn(post);
